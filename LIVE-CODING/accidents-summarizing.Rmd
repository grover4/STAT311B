...
According to your table from Exercise 7, what percentage of accidents that occurred in an intersection should result in injury if there is no association between the location of an accident and the severity?
