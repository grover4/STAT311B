...
Fill in the blanks for Exercises 1 - 5 to accomplish a specific task. Consult the slide deck "Introduction to Data: Data Manipulation" for help. Each code chunk has the `eval` option set to FALSE. Once you have filled in the blanks you may delete this option so your code will run when the document is knitted.
...
**More Practice: Answer the remaining problems by yourself. Create a new code chunk below each question and write code to answer it. **
