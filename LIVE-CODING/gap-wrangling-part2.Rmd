...
Fill in the blanks in the code provided in each code chunk to accomplish a specific task. Each code chunk has the `eval` option set to FALSE. Once you have filled in the blanks you may delete this option so your code will run when the document is knitted.
